...
export const trustedByLogos: TrustedByLogo[] = [
  { id: 1, name: "Example Law Firm A Placeholder Logo", logoUrl: "https://placehold.co/600/e2e8f0/64748b?text=Law+Firm+A+Placeholder+Logo" }, // Placeholder
  { id: 2, name: "Example Insurance Co Placeholder Logo", logoUrl: "https://placehold.co/200/e2e8f0/64748b?text=Insurance+Co+Placeholder+Logo" }, // Placeholder
  { id: 3, name: "Example Legal Group Placeholder Logo", logoUrl: "https://placehold.co/200/e2e8f0/64748b?text=Legal+Group+Placeholder+Logo" }, // Placeholder
  { id: 4, name: "Example Adjuster Firm Placeholder Logo", logoUrl: "https://placehold.co/200/e2e8f0/64748b?text=Adjusters+Placeholder+Logo" }, // Placeholder
  { id: 5, name: "Example SC Association Placeholder Logo", logoUrl: "https://placehold.co/200/e2e8f0/64748b?text=Association+Placeholder+Logo" }, // Placeholder
